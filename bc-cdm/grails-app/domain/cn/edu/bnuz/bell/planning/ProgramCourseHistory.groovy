...
class ProgramCourseHistory {
    ...
    static mapping = {
        ...
        scheduleType     defaultValue: "1", comment: '排课类型-0:不排课;1:按班级排课;2-按专业排课;3-按模块排课'
        ...
        /* 上 同ProgramCourse*/
        /* 下 新属性 */
        operation        comment: '操作-0：新建；1：更新；2：删除'
        creator          comment: '创建人'
